...
{   //                                    utilizzo il join per unire le tabelle tracce e artista tramite il nome dell'artista che deve essere quello inserito dall'utente.    Asc sta per crescente
	$ricerca=mysql_query("SELECT id_traccia,copertina,album,artista,titolo,num_traccia,anno,genere,prezzo FROM tracce WHERE artista LIKE '$testo%' ORDER BY album,num_traccia asc");
...
{
	$ricerca=mysql_query("SELECT id_traccia,album,artista,copertina,num_traccia,genere,anno,titolo,prezzo FROM tracce WHERE album LIKE '$testo' ORDER BY num_traccia");
	$riga=mysql_fetch_array($ricerca);
...
{
	$ricerca=mysql_query("SELECT id_traccia,artista,album,num_traccia,anno,genere,copertina,titolo,prezzo FROM tracce WHERE titolo LIKE '$testo%' ORDER BY album");
	$riga=mysql_fetch_array($ricerca);
